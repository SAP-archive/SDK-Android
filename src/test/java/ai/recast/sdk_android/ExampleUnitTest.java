...
public class ExampleUnitTest {
    ...
    public void testGetters() throws Exception {
		...
		options.put("token", "c695293367883d21229b95dd734540bd");
		options.put("language", "en");
        r = c.textRequest("Hello! How are you ? De we start at London or at Paris ?", options);
        se = r.getSentences();
        s = se[2];
    ...
    public void testSentenceGetters() {
        ...
        Client c = new Client("c695293367883d21229b95dd734540bd");
        assertTrue(c != null);
        Response r = c.textRequest("Hello! How are you ? I'm fine.", options);
    ...
    public void testEntitiesGetters() {
        ...
        assertTrue(((String)(ent[2].getField("gender"))).equals("unknown"));
    }
    ...
    public void testRequest() {
        ...
        assertTrue(r.getVersion().equals("1.3.0"));
    ...
    public void testMapOptions() {
        ...
        opts.put("token", "c695293367883d21229b95dd734540bd");
        opts.put("language", "fr");
        Response r = c.textRequest("J'adore android studio",opts);
        assertTrue(r.getLanguage().equals("fr"));
    }
    ...
    public void testFile() {
        ...
        Map<String, String> opts = new HashMap<>();
        opts.put("token", "c695293367883d21229b95dd734540bd");
        opts.put("language", "en");
        File f = new File(c.getClass().getClassLoader().getResource("invalid.wav").getPath());
        Response r = c.fileRequest(f.getPath(),opts);
